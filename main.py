...
dst = '/content/gdrive/MyDrive/aws_classifier/data/raw'
dst_1 ='/content/gdrive/MyDrive/aws_classifier/data/processed'
print('testo')
loader.get_data(src,dst)
loader.unzip_data(dst, dst_1)

#clean the data
num_skipped = 0
for folder_name in ("Cat", "Dog"):
    folder_path = os.path.join(dst_1,"PetImages", folder_name)
